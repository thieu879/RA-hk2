...
let ExampleClasss = (() => {
    ...
    let _exampleMethod_decorators;
    return _a = class ExampleClasss {
            exampleMethod(input) {
                return input;
            }
            constructor() {
        ...
        (() => {
            ...
            _exampleMethod_decorators = [combinedDecorator];
            __esDecorate(_a, null, _exampleMethod_decorators, { kind: "method", name: "exampleMethod", static: false, private: false, access: { has: obj => "exampleMethod" in obj, get: obj => obj.exampleMethod }, metadata: _metadata }, null, _instanceExtraInitializers);
